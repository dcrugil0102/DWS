...
class ACLArray extends ACLBase
{
    ...
    {
        $rolUsu = $this->_usuarios[$codUsuario]['cod_role'];

        return isset($this->_roles[$rolUsu]['permisos'][$numero]) && $this->_roles[$rolUsu]['permisos'][$numero] == true;
    }
    ...
    function getPermisos(int $codUsuario): array|false
    {
        if ($this->existeCodUsuario($codUsuario)) {
            $rolUsu = $this->_usuarios[$codUsuario]['cod_role'];
            return $this->_roles[$rolUsu]['permisos'];
        } else
            return false;
    }
